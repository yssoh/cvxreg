%% L1-ball in R3, Noiseless measurements
clear; close all; clc; addpath('codes'); addpath('objmesh')
fprintf('####################################################################\n')
fprintf('#Reconstructing the L1-ball in R^3 from noiseless support fn evals.#\n')
fprintf('####################################################################\n\n')
rng(626)
...
cvxprinter_master(A_am,struct('savepath',strcat('figures/Exp_F1a_s00_AMpoly_n',int2str(n))));
...
cvxprinter_master(A_LS,struct('savepath',strcat('figures/Exp_F1a_s00_LS_n',int2str(n))));
